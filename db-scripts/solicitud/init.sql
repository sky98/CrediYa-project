CREATE DATABASE IF NOT EXISTS pragma_solicitud_db;

CREATE TABLE IF NOT EXISTS pragma_solicitud_db.`estados` (
  `estado_id` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `nombre` VARCHAR(50) NULL,
  `descripcion` VARCHAR(100) NULL
);

CREATE TABLE IF NOT EXISTS pragma_solicitud_db.`tipo_prestamos` (
...
CREATE TABLE IF NOT EXISTS pragma_solicitud_db.`solicitudes` (
