package co.com.pragma.usecase.aprobarrechazarsolicitud;
...
public class AprobarRechazarSolicitudUseCase {
    ...
    public Mono<Solicitud> ejecutar(Solicitud solicitud){
        return solicitudRepository.obtenerSolicitudPorId(solicitud.getSolicitudId())
                .switchIfEmpty(Mono.error(new ErrorDominio("Solicitud con id : " + solicitud.getSolicitudId() + ", no encontrada", Set.of("soliictudId:"+solicitud.getSolicitudId()))))
